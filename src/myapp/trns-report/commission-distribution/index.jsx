...
const CommissionDistributionReport = () => {
  ...
  return (
    <Box>
      ...
      >
        <Box>
          <Typography variant="h5" fontWeight={700}>Commission Distribution Report</Typography>
...
export default CommissionDistributionReport;
